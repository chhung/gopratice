...
func main() {
	...
	for i := 1; i <= 3; i++ {
		...
		go func(workID int) {
			...
			dataChan <- fmt.Sprintf("Worker %d: Task Complete", workID)
		}(i)
	}
	...
	// 12. delay execute and file operation
	defer fmt.Println("\n[Exit] All process finished cleanly.")
